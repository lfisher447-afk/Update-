'use strict';
// ═══════════════════════════════════════════════════════════════════
//  BingeBox Omega — Core Modules (Combined) v3.0
//  Contains: Logger, CacheManager, SecurityConfig, CorsConfig, 
//            ApiProxy, and HealthMonitor.
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
//  3. SECURITY CONFIG (security-config.js)
// ═══════════════════════════════════════════════════════════════════
...
const ApiProxy = (() => {
  ...
  const TTL_MAP = [
    ['/trending',  60_000],['/search',    90_000],['/discover',  3   * 60_000],
    ['/movie',     10  * 60_000],
    ['/tv',        10  * 60_000],['/genre',     60  * 60_000],['/person',    30  * 60_000],
  ];
